...
import BasicComponent from "./Popupcomponent"
...
export default function MidArea({
  ...
  const handleRunClick = (containerId) => {
    ...
    setInputValues(newValues[containerId]);
     ...
     // Collect all values from newValues into a single array
     const collectedValues = Object.values(newValues).flat();
     setAllValues(collectedValues);
  };
