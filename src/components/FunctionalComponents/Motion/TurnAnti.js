...
const TurnAnti = ({}) => {
  ...
  return (
    <div style={parentContainerStyle}>
      <div className="bg-blue-400 rounded-md p-1 flex items-center relative">
        <p className="text-white text-xs mr-2 pt-2">Turn <FontAwesomeIcon icon={faUndo} size="lg" color="grey" /> {" "}</p>
